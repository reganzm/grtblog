          ...
          <div className="w-full z-10 bg-white dark:bg-gray-900 p-8" style={{
            ...
            <div className="flex flex-row items-center gap-4">
              ...
              <div className="flex gap-2">
                ...
                {moment.isHot && <span className="bg-red-500 text-white text-xs px-2 py-1 rounded"> HOT </span>}
              </div>
            </div>
            <div>
              ...
              <div className="flex justify-between items-center mt-4 text-gray-500 dark:text-gray-400">
                <div className="flex gap-4">
                  <span className="flex items-center gap-1 mr-4"><Eye size={16} /> {moment.views}</span>
                  <span className="flex items-center gap-1 mr-4"><Heart size={16} /> {moment.likes}</span>
