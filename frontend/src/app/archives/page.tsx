...
import { article_font, noto_sans_sc, noto_serif_sc_bold, varela_round } from '@/app/fonts/font';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="relative text-center mb-12">
        <h1 className={clsx(noto_sans_sc.className, 'text-4xl font-bold relative z-1')}>
          回忆与归档
        </h1>
        <span
