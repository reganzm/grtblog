...
const AllPostPageClient = ({ initialArticles, category }: {
  ...
  return (
    <>
      ...
      {loading && (
        <Skeleton>
          <Text className="text-xl font-bold transition"> 六月初至七月中旬｜前端学习简要总结，生活的小回顾 </Text>
          <Text
            className="text-gray-500 text-sm mt-2"> 在这段时间里我通过完成多个项目，深入学习了前端和全栈开发的技术。主要使用了
            Vue3、C++ Web 框架、jwt 鉴权、Docker、Nginx、FastAPI、微信网页开发、Vue2、Vant 组件库、TypeScript 和 React 等技术。
          </Text>
