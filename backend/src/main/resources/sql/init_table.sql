...
(
    ...
    `created`        TIMESTAMP                       DEFAULT CURRENT_TIMESTAMP COMMENT '用户创建时间',
    `updated`        TIMESTAMP                       DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '用户更新时间',
    `deleted`        TIMESTAMP COMMENT '用户删除时间（软删除），如果不为空则表示已删除',
...
(
    ...
    `created`   TIMESTAMP                   DEFAULT CURRENT_TIMESTAMP COMMENT '文章创建时间',
    `updated`   TIMESTAMP                   DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '文章更新时间',
    `deleted`   TIMESTAMP COMMENT '文章删除时间（软删除），如果不为空则表示已删除',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created`    TIMESTAMP                   DEFAULT CURRENT_TIMESTAMP COMMENT '评论创建时间',
    `updated`    TIMESTAMP                   DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '评论更新时间',
    `deleted`    TIMESTAMP COMMENT '评论删除时间（软删除），如果不为空则表示已删除',
...
(
    ...
    `created` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '标签创建时间',
    `updated` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '标签更新时间',
    `deleted` TIMESTAMP COMMENT '标签删除时间（软删除），如果不为空则表示已删除',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created`     TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '关注关系创建时间',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created`    TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '点赞关系创建时间',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '文件上传时间',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '配置创建时间',
    `updated` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '配置更新时间',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '信息创建时间',
    `updated` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '信息更新时间',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created`     TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '友链创建时间',
    `updated`     TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '友链更新时间',
    `deleted`     TIMESTAMP COMMENT '友链删除时间（软删除），如果不为空则表示已删除',
    PRIMARY KEY (`id`)
);
...
(
    ...
    `created` TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '说说创建时间',
    `updated` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '说说更新时间',
    `deleted` TIMESTAMP COMMENT '说说删除时间（软删除），如果不为空则表示已删除',
    PRIMARY KEY (`id`)
);